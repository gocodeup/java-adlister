...
insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'Eureka for sale', 'HP Eureka from legends for sale, $400', 5, 2);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'Playset of Blood Moon for sale', 'Playset of Blood Moon from the Dark, $200 OBO', 6, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Looking For Foil playset of High Tide from Fallen Empires', 'See title, price negotiable', 7, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (2, 'Assortment of cards from Homelands', 'See title', 8, 4);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'Foil brainstorm playset', 'Playset of foil brainstorm for sale, $400', 9, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'Vampiric Tutor for sale', 'see title, make me an offer', 10, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (2, 'Selling playset of Oath of Druids', 'Italian, NM condition', 11, 5);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Memory Jar', 'Selling my foil memory jar', 12, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'Looking for playset of Accumulated Knowledge', 'Need them for my miracles deck', 13, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'Need Spiritmonger for EDH deck', 'see title', 14, 2);

insert into ads(user_id, title, description, blocks_id, categories_id) values (2, 'LF promo Psychatog', 'Want to find some promo Dr. Teeth', 15, 6);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'LF foil Tendrils of Agony', 'Need a foil copy of Tendrils of Agony for my legacy storm deck', 16, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Need promo SoFaI', 'LF promo Sword of Fire and Ice to play with Stoneforge Mystic', 17, 6);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'LF Isamaru', 'Need an Isamaru, hound of Konda, to be my commander', 18, 2);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Bob playset for sale', 'Selling playset of Dark Confidant, OG for $200', 19, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Need Thrumming Stone', 'LF a Thrumming Stone from CSP', 20, 2);

insert into ads(user_id, title, description, blocks_id, categories_id) values (2, 'Need Damnation for Jund', 'Decided to buy back into Jund, need a Damnation', 21, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'LF SDCC promos', 'Title- willing to pay $350', 22, 6);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'Selling foil Manamorphoses', 'Selling foil Manamorphoses, $45 each, 8 available', 23, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (2, 'Need all the Alara trilands', 'I know they aren\'t worth much, but I need them for my cube.', 24, 4);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'LF OG JTMS playset', 'See title - willing to pay $500', 25, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Selling Foil Dismember', 'Perfect for your Death\'s Shadow deck', 26, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Selling LOTV playset', '$400 or best offer', 27, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'LF Shocklands', 'Need copies of Japanese shocklands, all accepted, no limit, offered 95% TCG low', 28, 5);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Need foil Purphorous', 'Need a foil copy for my commander deck', 29, 7);

insert into ads(user_id, title, description, blocks_id, categories_id) values (2, 'LF KTK trilands', 'Need a copy of all KTK trilands for my cube', 30, 4);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Selling TKS playset', 'Moving away from playing Eldrazi', 31, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'Need Liliana, the Last Hope and Collective Brutalities', 'See title, paying 95% of TCG low', 32, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Selling Kaladesh bulk', 'See title, $1 per 100 cards', 33, 4);

insert into ads(user_id, title, description, blocks_id, categories_id) values (1, 'Buying all Dinos', 'I love dinosours, so I\'m buying any you have', 34, 4);

insert into ads(user_id, title, description, blocks_id, categories_id) values (4, 'Selling the Scarab God Invocation', 'See title, make me an offer', 35, 6);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'Need 4 Teferi', 'Need 4 Teferi, Hero of Dominaria, paying 90% TCG Low', 36, 3);

insert into ads(user_id, title, description, blocks_id, categories_id) values (3, 'LF 4 KTGC', 'LF 4 Japanese special edition promos of Karn, the Great Creator', 37, 5);
